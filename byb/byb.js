...
$("#clear-bags").click(function() {
	deleteBags();
	Cookies.remove('byb', {path: "/", domain: '.hyzershop.com'});
	location.reload();
});
...
function bagButtons() {
	...
	var $singleProdBtns = $(".single-product main > div[data-disc-type].product-cat-discs > .summary").find(".add-to-bag, .remove-from-bag");
