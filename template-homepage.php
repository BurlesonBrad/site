			...
			<section class="tired-of-shopping col-full">
				...
				<script type="text/javascript">
					var getFeaturedBlogPost = function ($) {
						$.ajax({
							url: "http://blog.hyzershop.com/api/get_post/?slug=<?php echo get_post_meta(2, 'featured_blog_post', true); ?>",
							dataType: "jsonp",
						...
						function featuredBlogPost(data) {
							...
							$(".read-the-blog a")
								.html(oldHTML + "<div class='featured-blog-post-excerpt'>" + data.post.excerpt + "</div>")
