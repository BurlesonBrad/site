...
$brand = $brand[0]->slug;
?>
<li data-category="<?php echo (has_term('discs', 'product_cat', $post_id) ? 'product-cat-discs' : null); ?>" data-product-slug="<?php echo $post->post_name; ?>" data-disc-type="<?php echo $type; ?>" data-brand="<?php echo $brand; ?>" <?php post_class( $classes ); ?>>
...
<?php if ( has_term('discs', 'product_cat', $post_id) ): ?>
